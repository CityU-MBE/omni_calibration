...
%function [T3, dT3dom1,dT3dT1,dT3dom2,dT3dT2] = compose_motion(om1,T1,om2,T2)
...
dT3dom1 = zeros(3,3);
    ...
    om = [-1.634103744104301   0.078560905963010  -0.062358343621660];
	omex = [ 0 0 0];
	T = 1.0e+03 * [0.223005006800658; -4.301058562616457;
	0.757799797420037];
	Tex = [-800;0;0];
    
    % test derivatives
    test_derivatives(@compose_motion,1e-8,om,T,omex,Tex)
